/**
 * 単体テスト: HttpTrashRepository が 401 を引いたときの挙動 (BL-076 / AC-4).
 *
 * 受け入れ基準の出典:
 *   - docs/developer/features/authed-fetch-repositories/spec.md §AC-4
 ...
 *   - 実 `HttpTrashRepository.list()` を呼ぶ.
 ...
 *
 * AC-5 の補足: 本ファイルは `new HttpTrashRepository(BASE_URL)` (引数 1 つ) で生成し,
...
import { HttpTrashRepository } from "../src/repositories/trash-repository.js";
...
describe("AC-4 / HttpTrashRepository が 401 を引いたとき", () => {
