 ...
 *   - 実 `HttpProjectRepository.list()` を呼ぶ.
 ...
 *
 * AC-5 の補足: 本ファイルは `new HttpProjectRepository(BASE_URL)` (引数 1 つ) で生成し,
...
import { HttpProjectRepository } from "../src/repositories/project-repository.js";
...
describe("AC-2 / HttpProjectRepository が 401 を引いたとき", () => {
